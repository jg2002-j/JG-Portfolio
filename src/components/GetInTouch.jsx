				...
				<div className="flex-grow bg-stone-900 bg-opacity-75 noise rounded-lg py-20 flex flex-col justify-center gap-20">
					...
					<div className="flex flex-col lg:flex-row justify-center gap-5 lg:gap-10 px-10 lg:px-20">			
						...
						<div className="bg-stone-300 bg-opacity-10 hover:bg-stone-400 hover:bg-opacity-20 p-10 lg:p-20 rounded-lg w-full duration-1000 flex flex-col gap-2 lg:gap-5">
							...
							<a target="_blank" href="mailto:jai.2002.gandhi@gmail.com" className="max-w-fit text-stone-400 lg:text-2xl ease-in-out duration-500 hover:bg-stone-300 hover:bg-opacity-10 hover:rounded-lg hover:px-5 py-2 flex items-center"><Send className="inline h-4 lg:h-5 me-5"/>jai.2002.gandhi@gmail.com</a>
							<a target="_blank" href="https://wa.me/447481861855" className="max-w-fit text-stone-400 lg:text-2xl ease-in-out duration-500 hover:bg-stone-300 hover:bg-opacity-10 hover:rounded-lg hover:px-5 py-2 flex items-center"><MessagesSquare className="inline h-4 lg:h-5 me-5"/>+44 7481 861 855</a>
							<p className="max-w-fit text-stone-400 lg:text-2xl py-2 flex items-center"><MapPin className="inline h-4 lg:h-5 me-5" />London, United Kingdom</p>
						</div>
						...
						<div className="bg-stone-300 bg-opacity-10 hover:bg-stone-400 hover:bg-opacity-20 p-10 lg:p-20 rounded-lg w-full duration-1000 flex flex-col gap-2 lg:gap-5">
							...
							<a target="_blank" href="https://github.com/jg2002-j" className="max-w-fit text-stone-400 lg:text-2xl ease-in-out duration-500 hover:bg-stone-300 hover:bg-opacity-10 hover:rounded-lg hover:px-5 py-2 flex items-center ">
								<img className="aspect-square h-4 lg:h-5 me-4" src="https://cdn.simpleicons.org/github/a7a29f" alt="GitHub link"/>
								<span>GitHub</span>
							</a>
							<a target="_blank" href="https://www.linkedin.com/in/jg2002/" className="max-w-fit text-stone-400 lg:text-2xl ease-in-out duration-500 hover:bg-stone-300 hover:bg-opacity-10 hover:rounded-lg hover:px-5 py-2 flex items-center ">
								<img className="aspect-square h-4 lg:h-5 me-4" src="https://cdn.simpleicons.org/linkedin/a7a29f" alt="LinkedIn link"/>
								<span>LinkedIn</span>
							</a>
							<a target="_blank" href="https://www.dropbox.com/scl/fi/2y6z2e05ia477za2cebtz/JaiGandhiCV.pdf?rlkey=ssr2bkcj5l1xts5wliez85kol&dl=0" className="max-w-fit text-stone-400 lg:text-2xl ease-in-out duration-500 hover:bg-stone-300 hover:bg-opacity-10 hover:rounded-lg hover:px-5 py-2 flex items-center ">
								<img className="aspect-square h-4 lg:h-5 me-4" src="https://cdn.simpleicons.org/googledocs/a7a29f" alt="My CV link"/>
								<span>My CV</span>
							</a>
						</div>
