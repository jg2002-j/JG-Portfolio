...
const NavbarButton = (props) => {
   return (
      <a href={props.link} className="rounded-lg px-4 py-2 mx-5 my-10 group ease-in-out duration-700 hover:scale-150 hover:bg-neutral-700 flex justify-center align-middle">
         {NavIcon(props)}
      </a>
   )
}
