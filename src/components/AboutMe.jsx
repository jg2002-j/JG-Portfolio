	 	...
	 	<>
			<div className="2xl:mx-60 m-20 max-w-full min-h-dvh flex-col justify-center" id="aboutme">
				...
				<div className="flex flex-col 2xl:flex-row justify-evenly items-center mt-10 gap-[5rem]">
					<div>
						<h1 className="font-header text-4xl text-slate-300 mb-3">Header 1</h1>
					...
					<div>
						<h1 className="font-header text-4xl text-slate-300 mb-3">Header 2</h1>
					...
					<div>
						<h1 className="font-header text-4xl text-slate-300 mb-3">Header 3</h1>
