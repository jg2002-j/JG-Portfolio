...
function AboutMePage() {
	return (
		<div className="2xl:m-60 my-60 mx-20 max-w-full min-h-dvh flex-col justify-center" id="aboutme">
			<div className="flex flex-col 2xl:flex-row justify-center items-center min-h-[800px]">
				<div className="h-full w-full 2xl:w-3/5">
					<h1 className="text-5xl text-slate-200 text-header pb-11 2xl:p-[5rem]">Currently enrolled in an EdX Skills Bootcamp for front-end web development, seeking to leverage my experiences, creative outlook and technical skills in the dynamic world of front-end web development.</h1>
				</div>
				<AboutMeBento />
			</div>
