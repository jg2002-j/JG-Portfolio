...
function ContactPage() {
   ...
   return (
      <>
         <Navbar/>
         <div className="min-h-dvh w-vw flex flex-col 2xl:flex-row-reverse justify-center items-center gap-10 p-10 2xl:px-[20vw] relative bg-stone-900 bg-opacity-75 noise">
